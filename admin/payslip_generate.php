	...
	while($row = $query->fetch_assoc()){
		...
		$contents .= '
			...
			<table cellspacing="0" cellpadding="3">  
    	       	<tr>  
            		<td width="25%" align="right">Nombre del empleado: </td>
    	    	...
    	    	<tr>
    	    		<td width="25%" align="right">Empleado ID: </td>
    	    	...
    	    	<tr> 
    	    		<td></td> 
    	    		<td></td>
				 	<td width="25%" align="right"><b>Total Deducción:</b></td>
				 	<td width="25%" align="right"><b>'.number_format($total_deduction, 2).'</b></td> 
    	    	</tr>
    	    	<tr> 
    	    		<td></td> 
    	    		<td></td>
				 	<td width="25%" align="right"><b>Pago neto:</b></td>
