    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a><i class="fa fa-circle text-success"></i> línea</a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="overtime.php"><i class="fa fa-circle-o"></i> A Tiempo</a></li>
            <li><a href="cashadvance.php"><i class="fa fa-circle-o"></i> Adelantos</a></li>
        ...
        <li><a href="position.php"><i class="fa fa-suitcase"></i> <span>Posiciones</span></a></li>
        <li class="header">IMPRIMIBLES</li>
        <li><a href="payroll.php"><i class="fa fa-files-o"></i> <span>N. Sueldos</span></a></li>
        <li><a href="schedule_employee.php"><i class="fa fa-clock-o"></i> <span>Calendario</span></a></li>
      </ul>
    </section>
