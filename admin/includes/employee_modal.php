  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal formulario" id="formulario" method="POST" action="employee_add.php" enctype="multipart/form-data">
          <div class="form-group">
            <label for="firstname" class="col-sm-3 control-label">Nombres <i></i> </label>
          ...
          <div class="form-group">
            <label for="lastname" class="col-sm-3 control-label">Apellidos <i></i> </label>

            <div class="col-sm-9 colll">
              <input type="text" class="form-control" id="lastname" name="lastname" required>
            </div>
          </div>
          <div class="form-group">
            <label for="address" class="col-sm-3 control-label">DNI <i></i> </label>
          ...
          <div class="form-group">
            <label for="address" class="col-sm-3 control-label">Dirección <i></i> </label>
          ...
          <div class="form-group">
            <label for="datepicker_add" class="col-sm-3 control-label">Cumpleaños <i></i> </label>
          ...
          <div class="form-group">
            <label for="contact" class="col-sm-3 control-label">Monto <i></i> </label>
          ...
          <div class="form-group">
            <label for="gender" class="col-sm-3 control-label">Genero <i></i> </label>
          ...
          <div class="form-group">
            <label for="schedule" class="col-sm-3 control-label">Calendario</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="employee_edit.php">
          ...
          <div class="form-group">
            <label for="edit_schedule" class="col-sm-3 control-label">Calendario</label>
