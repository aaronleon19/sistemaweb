...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
      ...
      <div class="login_form_container">
        <div class="login_form">
          <button style="position: relative;text-decoration: none;z-index: 10;cursor: pointer;font-size: 12px;letter-spacing: 2px;border: 1px solid #00ccff;
    border-radius: 50px;
    background-color: #0c1022;
    justify-content: center;
    align-items: center;" onclick="startScanner()">Activar Escáner</button>
          <form id="attendance">
            <h3>Registrar asistencia</h3>

            <div class="inputBox" id="ie">
              <select class="raa" name="status">
            ...
            <div class="form-group has-feedback">
              ...
              <div class="input_group inputBox">
                ...
                <input type="text" id="employee" name="employee" placeholder="DNI EMPLEADO" class="input_text"
                  autocomplete="off" />
              </div>
            </div>
            ...
            <div class="col-xs-4">
              ...
              <button type="submit" class="button_group" id="login_button" value="Entrar" name="signin"><i
  ...
  <script>
    ...
    function startScanner() {
      ...
      scanner.addListener('scan', function (codigo) {
        document.getElementById('employee').value = codigo;
        var miBoton = document.getElementById('login_button');
        miBoton.click();
        var audio = new Audio('songs/noti.mp3');
        audio.play();
  ...
  <script>
        var Stats = function() {
            ...
            u.id = "fps", u.style.cssText = "padding:0 0 3px 3px;text-align:left;background-color:#fff", c.appendChild(u);
            var d = document.createElement("div");
            d.id = "fpsText", d.style.cssText = "color:#0fff;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px", d.innerHTML = "FPS", u.appendChild(d);
            var p = document.createElement("div");
            for (p.id = "fpsGraph", p.style.cssText = "position:relative;width:74px;height:30px;background-color:#0fff", u.appendChild(p); 74 > p.children.length;) {
            ...
            g.id = "msText", g.style.cssText = "color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px", g.innerHTML = "MS", m.appendChild(g);
            var y = document.createElement("div");
            for (y.id = "msGraph", y.style.cssText = "position:relative;width:74px;height:30px;background-color:#fff", m.appendChild(y); 74 > y.children.length;) {
                var f = document.createElement("span");
    ...
    <script type="text/javascript">
        ...
        (function(window) {
            ...
            function loop() {
                ...
                ctx.fillStyle = 'rgba(29, 23, 61, 0.219)';
